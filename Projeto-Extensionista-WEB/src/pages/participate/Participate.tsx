    ...
    <Box className="box-main">
      ...
      <Box className="content-container">
        ...
        <Typography variant="body1" className="content-text">
          <strong>1º -</strong> Faça seu cadastro, não esqueça de informar seus
          dados corretamente e chame um adulto para auxiliar;
        </Typography>
        <br/>
        <Typography variant="body1" className="content-text">
        ...
        <Typography variant="body2" className="reminder-text">
          Lembre-se sempre de verificar o ranking da sua turma e participar mais
          vezes para concorrer a uma viagem com seus colegas!
        </Typography>
      </Box>
    </Box>
  );
